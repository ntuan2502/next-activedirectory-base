...
import { Server, Users, Shield, ClipboardList, Settings, Building2, Network } from "lucide-react"
  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        { title: t("common.departments"), url: "/departments", icon: Network, permission: PERMISSIONS.DEPARTMENTS_READ },
